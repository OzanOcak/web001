        ...
        <div className="m-8 relative space-y-4">
          <div className="p-5 bg-white rounded-lg flex items-center justify-between space-x-8">
            <div className="flex-1">
              <div className="h-6 w-48 bg-gray-300 rounded font-bold px-2 dark:text-blue-700">
                web design
              </div>
            </div>
            <div>
          ...
          <div className="p-5 bg-white rounded-lg flex items-center justify-between space-x-8">
            <div className="flex-1">
              <div className="h-6 w-56 bg-gray-300 rounded font-bold px-2 dark:text-green-700">
                full stack
              </div>
            </div>
            <div>
          ...
          <div className="p-5 bg-white rounded-lg flex items-center justify-between space-x-8">
            <div className="flex-1">
              <div className="h-6 w-44 bg-gray-300 rounded font-bold px-2 dark:text-red-700">
                app development
              </div>
            </div>
            <div>
